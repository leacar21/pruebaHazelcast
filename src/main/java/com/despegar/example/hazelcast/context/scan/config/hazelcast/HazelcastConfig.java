package com.despegar.example.hazelcast.context.scan.config.hazelcast;
...
import com.despegar.example.hazelcast.context.scan.config.hazelcast.storage.EventsMapStore;
import com.despegar.example.hazelcast.context.scan.config.hazelcast.storage.EventsQueueStore;
import com.despegar.example.hazelcast.context.scan.config.hazelcast.storage.SubTeamMapStore;
import com.despegar.example.hazelcast.context.scan.config.hazelcast.util.HazelcastUtil;
