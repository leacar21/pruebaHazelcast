...
public class TransactionConfig
    ...
    @Pointcut("execution(* com.despegar.example.hazelcast..*.external..*.*(..))")
    public void external() {
    }

    @Pointcut("execution(* com.despegar.example.hazelcast..*.internal..*.*(..))")
    public void internal() {
    }

    @Pointcut("execution(* com.despegar.example.hazelcast..*.integration..*.*(..))")
    public void integration() {
    }

    @Pointcut("execution(* com.despegar.example.hazelcast..*.support..*.*(..))")
    public void support() {
    }

    @Pointcut("execution(* com.despegar.example.hazelcast.repository.dao..*.*(..))")
    public void dao() {
    }
}
